...
require_once "./modals/edit-fluent-languages.php";
require_once "./modals/edit-learning-languages.php";
  ...
  <div class="row">
    <div class="col-md-4 p-3 d-flex d-md-block">
      <div class="col-6 col-md-12 d-flex flex-column align-items-center">
        <img class="img-fluid pfp" src="<?= $profile_picture_path ?>" alt="profile picture">
    ...
    <div class="col-md-8 pt-3">
      ...
      <div class="text-box text text-white p-3 mb-3">
        ...
        <div class="d-flex justify-content-center">
          <button class="edit-button text-white text"
                  data-bs-toggle="modal" data-bs-target="#edit-fluent-languages">
            <i class="fa-regular fa-pen-to-square"></i>
            Edit
          </button>
        </div>
      ...
      <div class="text-box text text-white p-3 mb-3">
        ...
        <div class="d-flex justify-content-center">
          <button class="edit-button text-white text"
                  data-bs-toggle="modal" data-bs-target="#edit-learning-languages">
            <i class="fa-regular fa-pen-to-square"></i>
            Edit
          </button>
        </div>
